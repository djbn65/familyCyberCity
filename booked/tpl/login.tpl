			...
			<div id="login-box" class="col-xs-12 default-box straight-top">
				...
				<div class="col-xs-12 {if $ShowRegisterLink}col-sm-6{/if}">
					<div class="checkbox">
						...
						<label for="rememberMe" style="color:#666; font-weight: bold">{translate key=RememberMe}</label>
					</div>
				</div>

                {if $ShowRegisterLink}
                    <div class="col-xs-12 col-sm-6 register">
                    <span class="bold" style="color: #2e45f7">{translate key="FirstTimeUser?"}
                    <a href="{$RegisterUrl}" {$RegisterUrlNew}
                       title="{translate key=Register}" style="color: #666">{translate key=Register}</a>
                    </span>
                    </div>
                {/if}
