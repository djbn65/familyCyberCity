 ...
 */
$conf['settings']['app.title'] = 'Party Reservations';			// application title
...
$conf['settings']['admin.email'] = '17dburr@stu.sgdragons.org';         // email address of admin user
$conf['settings']['admin.email.name'] = 'Family Cyber City Administrator';	// name to be used in From: field when sending automatic emails
...
$conf['settings']['script.url'] = 'http://familycybercity.byethost.com/booked/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
$conf['settings']['image.upload.directory'] = 'http://familycybercity.byethost.com/images'; // full or relative path to where images will be stored
$conf['settings']['image.upload.url'] = 'http://familycybercity.byethost.com/images';       // full or relative path to show uploaded images from
...
$conf['settings']['home.url'] = 'http://familycybercity.byethost.com'; 	      					// the url to open when the logo is clicked
$conf['settings']['logout.url'] = 'http://familycybercity.byethost.com/booked'; 	      					// the url to be directed to after logging out
...
$conf['settings']['database']['user'] = 'b7_20462648';        // database user with permission to the booked database
$conf['settings']['database']['password'] = 'Firework12';
$conf['settings']['database']['hostspec'] = 'sql107.byethost7.com';        // ip, dns or named pipe
$conf['settings']['database']['name'] = 'b7_20462648_booked';
/**
 ...
 */
$conf['settings']['install.password'] = 'Firework12';
/**
 * Pages
 */
