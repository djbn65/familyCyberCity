...
USE booked;
GRANT ALL on booked.* to 'id803499_17dburr'@'localhost' identified by 'Firework12';
GRANT ALL on booked.* to 'id803499_17dburr'@'localhost' identified by 'Firework12';SET foreign_key_checks = 0;
